...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        1 & 0,3990 & 0,1571 & 0,0385 \\
        \hline
        2 & 0,1648 & 0,6121 & 0,0298 \\
        \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \hline
        T1 & $+2{,}6975$ & $+2{,}3777$ & $-1{,}0025$ & 347 & 0,2374 \\
        \hline
        T2 & $+2{,}3776$ & $+2{,}6975$ & $-1{,}0025$ & 347 & 0,2374 \\
        \hline
        T3 & $+2{,}6975$ & $+2{,}3777$ & $-1{,}0026$ & 347 & 0,2374 \\
        \hline
        T4 & $+2{,}3776$ & $+2{,}6975$ & $-1{,}0026$ & 346 & 0,2374 \\
        \hline
        T5 & $+2{,}6975$ & $+2{,}3776$ & $-1{,}0026$ & 346 & 0,2374 \\
        \hline
    \end{tabular}%
    }
\end{table}
...
As Figuras~\ref{fig:eqm_t1} a~\ref{fig:eqm_t5} apresentam a evolução do EQM em função do número de épocas para os cinco treinamentos. Em todos os casos, a convergência ocorreu entre 346 e 347 épocas, com EQM final de aproximadamente 0,2374. As curvas evidenciam queda acentuada nas primeiras épocas e estabilização progressiva.
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \hline
        1  & 0,8705 & 0,9329 & $-1$ & $-1{,}0024$ & $-1$ \\
        \hline
        2  & 0,0388 & 0,2703 & $+1$ & $-0{,}3231$ & $-1$ \\
        \hline
        3  & 0,8236 & 0,4458 & $-1$ & $-0{,}9139$ & $-1$ \\
        \hline
        4  & 0,7075 & 0,1502 & $+1$ & $-0{,}2200$ & $-1$ \\
        \hline
        5  & 0,9587 & 0,8663 & $-1$ & $-1{,}0024$ & $-1$ \\
        \hline
        6  & 0,6115 & 0,9365 & $-1$ & $-0{,}9877$ & $-1$ \\
        \hline
        7  & 0,3534 & 0,3646 & $+1$ & $+0{,}9664$ & $+1$ \\
        \hline
        8  & 0,3268 & 0,2766 & $+1$ & $+1{,}3231$ & $+1$ \\
        \hline
        9  & 0,6129 & 0,4518 & $-1$ & $-0{,}4681$ & $-1$ \\
        \hline
        10 & 0,9948 & 0,4962 & $-1$ & $-0{,}9965$ & $-1$ \\
        \hline
        \multicolumn{5}{|c|}{\textbf{Taxa de acertos}} & \textbf{80\%} \\
        \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|}
        ...
        \hline
        VP (Verdadeiro Positivo) & 2 \\
        \hline
        VN (Verdadeiro Negativo) & 6 \\
        \hline
        FP (Falso Positivo) & 0 \\
        \hline
        FN (Falso Negativo) & 2 \\
...
Os dois erros obtidos são Falsos Negativos: as amostras 2 ($x_1 = 0{,}0388$, $x_2 = 0{,}2703$) e 4 ($x_1 = 0{,}7075$, $x_2 = 0{,}1502$), embora positivas ($d = +1$), foram classificadas como $-1$. Isso ocorre porque ambas se encontram em regiões do espaço de entrada com baixa ativação gaussiana em relação aos dois centros encontrados, resultando em $y < 0$. Estratégias para melhorar o desempenho incluem o aumento do número de clusters $K$ (mais neurônios na camada escondida), a ampliação do conjunto de treinamento ou o ajuste da inicialização dos centros para cobrir melhor as regiões de fronteira.
